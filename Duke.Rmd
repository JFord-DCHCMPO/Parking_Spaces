...
An updated 2020 geodatabase of Duke's facilities was used to update the base year parking spaace supply. 
...
leaflet() %>% addPolygons(data = x %>% slice(1:nrow(x))) %>% addProviderTiles("CartoDB.Positron")
```
