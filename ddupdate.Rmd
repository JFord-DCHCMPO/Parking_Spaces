...
Total parking spaces from the DDPS equalled 10,637 after factoring out residential trips and only including those spots within the Durham PASA.  The table below shows the existing 2013, 2016, 2025 and 2045 parking space data for Durham's PASA, along with the updated 2018 data from the DDPS. The total 10,637 parking spaces were distributed to Work and Visitor categories by keeping the 2016 distribution between the two categories constant (62% work and 38% visitor). 

Annual growth factors for both work (total employment) and visitor (service + retail) employment are calculated and used to forecast future parking spaces in 2020, 2030, 2040 and 2050.  
...
From the DDPS, total parking uses equalled 15,332, or when doubled equals total capacity of 30,664. Using the ratio of 2018 DDPS capacity to total spaces, we factor the future parking spaces calculated in the previous step to come up with a future parking capacity figure. 
