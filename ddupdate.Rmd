...
The impetus for this process was the existing 2016 and forecasted 2025-2035-2045 parking capacity for Durham CBD appeared very high, possibly falsely representing the number of trips the area can handle without adjusting parking costs. After the number of parking spots were updated for 2018, a new space to capacity ratio was developed after multiple iterations.   
...
Using the trip attraction ratios, and after multiple iterations, the final parking capacity table was developed below for Durham:
