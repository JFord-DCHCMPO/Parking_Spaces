...
Parking Capacity Data is sourced from the ParkCap.bin file in the respective model scenario year 'Programs' folder within from the TRMv6.2 official svn repository.  

Parking capacity is a composite measurement of the total supply of parking spaces and is measured by PASA type and trip purpose. It is a function of the base year (2013) and future scenario year parking spaces, current and future number of employee/enrollee in the PASA, and vehicles parked per space. The base year for the parking spaces is 2013, therefore all parking capacity below is based off 2013 data. Growth factors based off the employment growth for Workers (Total Employment), Visitors (Retail + Visitors) and University (Off-Campus Students). These were used to extend the 2013 base year to 2025-2035-2045 scenarios. 
